...
\begin{tikzpicture}[very thick, fg, x=0.7cm]\small
    ...
    %% Events
    \draw[<-,thick,color=fg,dashed] ($(E1)+(0,0.1)$) -- ($(E1)+(0,1.5)$) 
    node [above=0pt,align=center,fg] {\scriptsize \textbf{1948} \\ 
    \scriptsize First \\[-4pt]\scriptsize appearance.};
    \draw[<-,thick,color=fg,dashed] ($(E2)+(0,0.1)$) -- ($(E2)+(0,1.5)$) 
    node [above=0pt,align=center,fg] {\scriptsize \textbf{1963} \\ 
    \scriptsize First analysis. \\[-4pt]};
    \draw[<-,thick,color=fg,dashed] ($(E3)+(0,0.1)$) -- ($(E3)+(0,1.5)$) 
    node [above=0pt,align=center,fg] {\scriptsize \textbf{1977} \\ 
    \scriptsize Analysis in \\[-4pt] \scriptsize fixed precision.};
    \draw[<-,thick,color=fg,dashed] ($(E4)+(0,0.1)$) -- ($(E4)+(0,1.5)$) 
    node [above=0pt,align=center,fg] {\scriptsize \textbf{2006} \\ 
    \scriptsize Low precision \\[-4pt] \scriptsize factorization.};
    \draw[<-,thick,color=fg,dashed] ($(E5)+(0,0.1)$) -- ($(E5)+(0,1.5)$) 
    node [above=0pt,align=center,fg] {\scriptsize \textbf{2018} \\ 

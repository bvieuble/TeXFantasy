...
\begin{tikzpicture}
    ...
    [
        ...
        \addplot[scatter,mypurple-mild,only marks,mark=*,mark size=3pt,
                 ...
                 every node near coord/.append style={color=fg,
                                                      rotate=\angle,
                                                      xshift=\xshift,
                                                      yshift=\yshift,
                                                      font=\normalsize}] 
        ...
        \draw[solid,very thick,fg] (axis cs:2E+7,0) -- (axis cs:2E+7,1E-18);
        \draw[solid,very thick,fg] (axis cs:1E+10,0) -- (axis cs:1E+10,1E-18);
